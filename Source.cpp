...
void PrintTree1(Derevo* root, int level);
...
int main()
{
    ...
    do {
        ...
        cout << " [1] - створенн€ дерева" << endl;
        cout << " [2] - збалансоване дерево" << endl;
        cout << " [3] - добавленн€ вузла до даного дерево" << endl;
        cout << " [4] - балансуванн€ дерева" << endl;
        cout << " [5] - вилученн€ вузла з даного дерево" << endl;
        cout << " [6] - пошук вузл≥в дерева" << endl;
        cout << " [7] - не збалансоване дерево" << endl << endl;

        cout << " [0] - вих≥д та завершенн€ роботи програми" << endl << endl;

        cout << "¬вед≥ть пункт меню: "; cin >> menutowar;
        cout << endl;
        switch (menutowar)
        {
        case 1:
            cout << "¬вед≥ть к≥льк≥сть: "; cin >> kilkist;
            cout << endl;
            for (int i = 0; i < kilkist; i++)
            {
                cout << "¬вед≥ть значенн€ є" << i + 1 << ": "; cin >> value;
        ...
        case 2:
            ...
            break;
        case 3:
            cout << "¬вед≥ть к≥льк≥сть  щоб добавити до даного дерева: "; cin >> N;
            for (int i = 0; i < N; i++)
            {
                cout << "¬вед≥ть значенн€ є" << i + 1 << ": "; cin >> value;
        ...
        case 4:
            ...
            break;
        case 5:
            cout << "¬вед≥ть значенн€  дл€ вилученн€: "; cin >> value;
            node = BinarySearchDelete(node, value, level);
            break;
        case 6:
            cout << "¬вед≥ть значенн€ дл€ пошуку: "; cin >> value;
            b = false;
            Find_vyzol(node, value, b);

            if (b)
                cout << "¬ведене знайшлос€: ";
            else
                cout << "¬ведене не знайшлос€: ";
            break;
        case 7:
            PrintTree1(node, 0);
            break;
        case 0:
            cout << endl;
            cout << "завершенн€ роботи програми" << endl;
            break;
        default:
            cout << endl;
